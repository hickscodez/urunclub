...
<script defer data-domain="urunclub.com" src="https://plausible.io/js/script.js"></script>
...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .topnav a {
    font-family:'DIN Alternate', Menlo, sans-serif; font-size:11px; font-weight:700;
    letter-spacing:0.14em; text-transform:uppercase; color:var(--ink);
    text-decoration:none; border-bottom:1px solid rgba(10,17,32,0.25); padding-bottom:2px;
  }
  ...
  /* tier control */
  .tierbar { background:var(--tint); margin-top:48px; padding:28px 0 30px; position:sticky; top:0; z-index:5; border-top:1px solid var(--line); border-bottom:1px solid var(--line); }
  ...
  .joiner { background:var(--tint); margin-top:64px; padding:56px 0 64px; border-top:1px solid var(--line); border-bottom:1px solid var(--line); }
